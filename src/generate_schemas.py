...
from classes_input import (conductivity as conductivity_input,
                           ...
                           capacity_cycling as cycling_input
                           )
from classes_output import (conductivity as conductivity_output,
                           ...
                           capacity_cycling as cycling_output)
...
'''
    quantity_path = BASEPATH_QUANTITIES / 'capacity_cycling' / 'capacity_cycling.json'
    generate_quantity('capacity', 'cycling', cycling_input, cycling_output, BASEPATH_QUANTITIES)